...
cmd_output_directory =getwd()# '/Users/gemmachaters/Dropbox/Mac/Documents/GitHub/GBADsLiverpool/Ethiopia Workspace/Program outputs'
,
# Full path to scenario control file
cmd_scenario_file = "AHLE scenario parameters CATTLE (3).xlsx"# '/Users/gemmachaters/Dropbox/Mac/Documents/GitHub/GBADsLiverpool/Ethiopia Workspace/Code and Control Files/AHLE scenario parameters CATTLE.xlsx'
,
# Optional: only run the first N scenarios from the control file
cmd_run_first_n_scenarios = "cattle_trial_CLM_current"#-1 	# -1 means use all scenarios in control file
# ,
# return ="table"# "iter" 
){
...
#	Num_months <- 12
  ...
  #oxen (castrates)
   ...
   Value_of_Total_Mortality_J_M <- Value_of_Total_Mortality_JF_M + Value_of_Total_Mortality_JM_M
	...
	return(list(
	  Total_number_change_NF_M 	=	Total_number_change_NF_M 	,
	  Total_number_change_NM_M 	=	Total_number_change_NM_M 	,
	  Total_number_change_JF_M 	=	Total_number_change_JF_M 	,
	  Total_number_change_JM_M	=	Total_number_change_JM_M	,
	  Total_number_change_AF_M 	=	Total_number_change_AF_M 	,
	  Total_number_change_AM_M 	=	Total_number_change_AM_M 	,
	  Total_number_change_O_M 	=	Total_number_change_O_M 	,
	  Total_number_change_M 	=	Total_number_change_M 	,
	  Value_Milk_M 	=	Value_Milk_M 	,
	  Value_Hides_JF_M 	=	Value_Hides_JF_M 	,
	  Value_Hides_JM_M 	=	Value_Hides_JM_M 	,
	  Value_Hides_AF_M 	=	Value_Hides_AF_M 	,
	  Value_Hides_AM_M 	=	Value_Hides_AM_M 	,
	  Value_Hides_O_M 	=	Value_Hides_O_M 	,
	  Value_Hides_M 	=	Value_Hides_M 	,
	  Value_Manure_M 	=	Value_Manure_M 	,
	  Value_Manure_NF_M 	=	Value_Manure_NF_M 	,
	  Value_Manure_NM_M 	=	Value_Manure_NM_M 	,
	  Value_Manure_JF_M 	=	Value_Manure_JF_M 	,
	  Value_Manure_JM_M 	=	Value_Manure_JM_M 	,
	  Value_Manure_AF_M 	=	Value_Manure_AF_M 	,
	  Value_Manure_AM_M 	=	Value_Manure_AM_M 	,
	  Value_Manure_O_M 	=	Value_Manure_O_M 	,
	  Production_value_herd_offteake_hide_man_NF_M 	=	Production_value_herd_offteake_hide_man_NF_M 	,
	  Production_value_herd_offteake_hide_man_NM_M 	=	Production_value_herd_offteake_hide_man_NM_M 	,
	  Production_value_herd_offteake_hide_man_JF_M 	=	Production_value_herd_offteake_hide_man_JF_M 	,
	  Production_value_herd_offteake_hide_man_JM_M 	=	Production_value_herd_offteake_hide_man_JM_M 	,
	  Production_value_herd_offteake_hide_man_AF_M 	=	Production_value_herd_offteake_hide_man_AF_M 	,
	  Production_value_herd_offteake_hide_man_AM_M 	=	Production_value_herd_offteake_hide_man_AM_M 	,
	  Production_value_herd_offteake_hide_man_O_M 	=	Production_value_herd_offteake_hide_man_O_M 	,
	  Production_value_herd_offteake_hide_man_M 	=	Production_value_herd_offteake_hide_man_M 	,
	  Gross_margin_M 	=	Gross_margin_M 	,
	  Gross_margin_NF_M 	=	Gross_margin_NF_M 	,
	  Gross_margin_NM_M 	=	Gross_margin_NM_M 	,
	  Gross_margin_JF_M 	=	Gross_margin_JF_M 	,
	  Gross_margin_JM_M 	=	Gross_margin_JM_M 	,
	  Gross_margin_AF_M 	=	Gross_margin_AF_M 	,
	  Gross_margin_AM_M 	=	Gross_margin_AM_M 	,
	  Gross_margin_O_M 	=	Gross_margin_O_M 	,
	  Num_Offtake_N_M 	=	Num_Offtake_N_M 	,
	  Num_Offtake_J_M 	=	Num_Offtake_J_M 	,
	  Pop_growth_N_M 	=	Pop_growth_N_M 	,
	  Pop_growth_J_M 	=	Pop_growth_J_M 	,
	  Total_number_change_N_M 	=	Total_number_change_N_M 	,
	  Total_number_change_J_M 	=	Total_number_change_J_M 	,
	  Total_Mortality_N_M 	=	Total_Mortality_N_M 	,
	  Total_Mortality_J_M 	=	Total_Mortality_J_M 	,
	  Value_of_Total_Mortality_N_M 	=	   Value_of_Total_Mortality_N_M 	,
	  Value_of_Total_Mortality_J_M 	=	   Value_of_Total_Mortality_J_M 	,
	  Quant_Liveweight_kg_J_M 	=	Quant_Liveweight_kg_J_M 	,
	  Quant_Manure_N_M 	=	Quant_Manure_N_M 	,
	  Quant_Manure_J_M 	=	Quant_Manure_J_M 	,
	  Quant_Hides_J_M 	=	Quant_Hides_J_M 	,
	  Cumilative_Dry_Matter_N_M 	=	Cumilative_Dry_Matter_N_M 	,
	  Cumilative_Dry_Matter_J_M 	=	Cumilative_Dry_Matter_J_M 	,
	  Value_Offtake_N_M 	=	Value_Offtake_N_M 	,
	  Value_Offtake_J_M 	=	Value_Offtake_J_M 	,
	  Value_Herd_Increase_N_M 	=	Value_Herd_Increase_N_M 	,
	  Value_Herd_Increase_J_M 	=	Value_Herd_Increase_J_M 	,
	  Total_Value_increase_N_M 	=	Total_Value_increase_N_M 	,
	  Total_Value_increase_J_M 	=	Total_Value_increase_J_M 	,
	  Value_Manure_N_M 	=	Value_Manure_N_M 	,
	  Value_Manure_J_M 	=	Value_Manure_J_M 	,
	  Value_Hides_J_M 	=	Value_Hides_J_M 	,
	  Production_value_herd_offteake_hide_man_N_M 	=	Production_value_herd_offteake_hide_man_N_M 	,
	  Production_value_herd_offteake_hide_man_J_M 	=	Production_value_herd_offteake_hide_man_J_M 	,
	  Feed_cost_N_M 	=	Feed_cost_N_M 	,
	  Feed_cost_J_M 	=	Feed_cost_J_M 	,
	  Labour_cost_N_M 	=	Labour_cost_N_M 	,
	  Labour_cost_J_M 	=	Labour_cost_J_M 	,
	  Health_cost_N_M 	=	Health_cost_N_M 	,
	  Health_cost_J_M 	=	Health_cost_J_M 	,
	  Capital_cost_N_M 	=	Capital_cost_N_M 	,
	  Capital_cost_J_M 	=	Capital_cost_J_M 	,
	  Infrastructure_cost_N_M 	=	Infrastructure_cost_N_M 	,
	  Infrastructure_cost_J_M 	=	Infrastructure_cost_J_M 	,
	  Total_expenditure_N_M 	=	Total_expenditure_N_M 	,
	  Total_expenditure_J_M 	=	Total_expenditure_J_M 	,
	  Gross_margin_N_M 	=	Gross_margin_N_M 	,
	  Gross_margin_J_M 	=	Gross_margin_J_M 	,
	  Gross_margin_M_month12th =	Gross_margin_M[,12] ,
	  summary_df_updated = summary_df_updated))
}
...
if (cmd_run_first_n_scenarios !="all"){
	ahle_scenarios_cln <- ahle_scenarios_cln[ ,cmd_run_first_n_scenarios]
}
...
for (COLNAME in colnames(ahle_scenarios_cln)){
	...
	filename <- paste('ahle_' ,COLNAME, Sys.time() %>% as.character() %>% gsub(":",".",.),
	                  	                  '.csv', sep='')
	write.csv(result["summary_df_updated"],file.path(cmd_output_directory,filename),row.names=FALSE)
}
result
}
