        ...
        pop[[ i+1 ]] <- pmap(
          ...
          function(pre, post, .t, .p, .n, .j, .a, .f, .m, N0, g, pt, pf, pfm, ld, ady, mvl, 
            ...
            Df = df %>% mutate(
              ...
              ValOftk = NOftk *s(fv), 
              ValHerd = diff *s(fv), 
              ValMort = D*s(fv), #Updated on 24 Apr 2023 by SK
      ...
      mutate_all(
        function(x){
          lab=c("B", "Gi", "Go", "D", "O", "C", "sum", "come", "leave", "diff", "new", 
                ...
                "ValMort",#Updated on 24 Apr 2023 by SK 
                "TotVal", 
          ...
          name=c("Births", "Growth in", "Growth out", "Deaths", "Offtakes", "Culls", "Sum", "Inflow", "Outflow", "Difference", "Population", 
                 ...
                 "Value of Mortality",#Updated on 24 Apr 2023 by SK
                 ...
                 "Juvenile Female", "Juvenile Male",  #>10-Apr-2023, updated by SK
                 "Subadult Female", "Subadult Male",  #>10-Apr-2023, updated by SK
                 "Adult Female", "Adult Male", 
                 "Overall", "Juvenile Combined", "Subadult Combined", "Adult Combined",  #>10-Apr-2023, updated by SK
                 "Female Combined", "Male Combined")
